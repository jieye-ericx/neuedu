...
class GoldenSpirit:
    ...
    def __init__(self, name):
        ...
        """
        self.bar_name = name
        self.url = "https://search.bilibili.com/all?keyword=" + self.bar_name + "&page={}"
    ...
    def save_data(self, content, page_count):
        """保存数据"""
        file_name = "{}-第{}页.html".format(self.bar_name, page_count)
        with open('./GoldenSpiritHtml/' + file_name, 'w', encoding='utf-8') as f:
            f.write(content)
